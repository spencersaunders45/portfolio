...
export default () => {
  return(
    <div className='container-fluid d-flex justify-content-center align-items-center'>
      <div id="main">
        <div className='link-side d-flex flex-column align-items-center justify-content-center'>
          <img id='profile-pic' src={Me} alt="White male with beard in blue suite with red floaral tie and glasses" />
          <h2 id='name'>Spencer Saunders</h2>
          <div id='social-links d-flex'>
        ...
        <div className='info-side border border-white'>
      ...
      <footer>
        <a id='freepik' className='fixed-bottom justify-content-start' href='https://www.freepik.com/vectors/background'>Background vector created by freepik - www.freepik.com</a>
      </footer>
    </div>
  )
}